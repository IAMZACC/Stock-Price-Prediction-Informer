...
parser.add_argument('--seq_len', type=int, default=150, help='input sequence length of Informer encoder')
...
data_parser = {
    ...
    'WTH': {'data': 'WTH.csv', 'T': 'WetBulbCelsius', 'M': [12, 12, 12], 'S': [1, 1, 1], 'MS': [1, 1, 1]},
